...
public class setting implements ToggleHandler {
    ...
    void showframeSetting(){
        ...
        group.addActor(frm);
        Label text = new Label(C.lang.setting,new Label.LabelStyle(BitmapFontC.robotoVi, Color.BROWN));
        text.setPosition(0,-frm.getHeight()/2+60,Align.center);
        group.addActor(text);
        Image btnClose = GUI.createImage(atlas,"btnClose2");
        btnClose.setPosition(frm.getWidth()/2-btnClose.getWidth()/2,-frm.getHeight()/2+btnClose.getHeight()/2,Align.center);
        group.addActor(btnClose);
        eventbtnClose(btnClose);

        ////////// btn TurnOn /////////
        Image btnTurnOnSound = GUI.createImage(atlas,"turnOnSo");
        btnTurnOnSound.setPosition(-btnTurnOnSound.getWidth(),0,Align.center);
        group.addActor(btnTurnOnSound);
        ///////// btn TurnOff ///////
        Image btnTurnOffSound = GUI.createImage(atlas,"turnOffSo");
        btnTurnOffSound.setPosition(-btnTurnOnSound.getWidth(),0,Align.center);
        ...
        ////////////////// music///////////////////
        ////////// btn TurnOn /////////
        Image btnTurnOnMusic = GUI.createImage(atlas,"turnOnMs");
        btnTurnOnMusic.setPosition(btnTurnOnMusic.getWidth(),0,Align.center);
        group.addActor(btnTurnOnMusic);
        ///////// btn TurnOff ///////
        Image btnTurnOffMusic = GUI.createImage(atlas,"turnOffMs");
        btnTurnOffMusic.setPosition(btnTurnOnMusic.getWidth(),0,Align.center);
